...
class_name RunningAsceticWardenState
...
func _ready() -> void :
	...
	if warden:
		...
		teleport_range = warden.teleport_range
		alert_duration = warden.alert_duration
...
func physics_update(delta: float) -> void :
	...
	if distance_to_player > teleport_range:
		transition.emit("TeleportEnemyState")
		return
