...
class_name RunningBloomHeraldState
...
func _ready() -> void :
	...
	if herald:
		...
		preferred_distance = herald.preferred_distance
		turn_speed = herald.turn_speed
		alert_duration = herald.alert_duration
...
func physics_update(delta: float) -> void :
	...
	var strafe_offset = right * sin(strafe_angle) * (preferred_distance * 0.3)
