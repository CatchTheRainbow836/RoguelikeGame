...
class_name RunningLuminousSentinelState
...
func _ready() -> void :
    ...
    if sentinel:
        ...
        preferred_distance = sentinel.preferred_distance
        turn_speed = sentinel.turn_speed
        alert_duration = sentinel.alert_duration
