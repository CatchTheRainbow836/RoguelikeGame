...
class_name RunningSteamcragBehemothState
...
func _ready() -> void :
	...
	if behemoth:
		speed = behemoth.speed
		accel = behemoth.accel
		view_distance = behemoth.view_distance
		fov_degrees = behemoth.fov_degrees
		melee_range = behemoth.melee_range
