...
class_name PhaseThreeSplashEdenRemnantAttackState
...
func _ready() -> void :
    ...
    if boss:
        splash_damage = boss.phase3_splash_damage
        splash_radius = boss.phase3_splash_radius
        cylinder_height = boss.phase3_splash_cylinder_height
        splash_count = boss.phase3_splash_count
        area_radius = boss.phase3_splash_area_radius
...
func _generate_positions() -> Array:
    ...
    for i in range(splash_count):
        ...
        while not valid_position and attempts < max_attempts:
            ...
            new_pos = PLAYER.global_position + offset
            new_pos.y = 0
